...
class allViewController: UIViewController ,UITableViewDelegate , UITableViewDataSource , UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        self.title = "Trending"
        Alamofire.request("https://github.com/trending?since="+whatPeriod).responseString { response in
            ...
            myTextField.center = CGPoint(x: self.fullScreenSize.width * 0.5, y: self.fullScreenSize.height * 0.05)
            self.view.addSubview(myTextField)
            let tap = UITapGestureRecognizer(target: self,action:#selector(allViewController.hideKeyboard(tapG:)))
