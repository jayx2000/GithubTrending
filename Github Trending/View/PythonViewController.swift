...
class PythonViewController: UIViewController ,UITableViewDelegate , UITableViewDataSource , UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        self.title = "Trending"
        Alamofire.request("https://github.com/trending/python?since="+whatPeriod).responseString { response in
            ...
            let tap = UITapGestureRecognizer(target: self,action:#selector(PythonViewController.hideKeyboard(tapG:)))
