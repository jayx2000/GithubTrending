...
class PHPViewController: UIViewController ,UITableViewDelegate , UITableViewDataSource , UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        self.title = "Trending"
        Alamofire.request("https://github.com/trending/php?since="+whatPeriod).responseString { response in
            ...
            let tap = UITapGestureRecognizer(target: self,action:#selector(PHPViewController.hideKeyboard(tapG:)))
