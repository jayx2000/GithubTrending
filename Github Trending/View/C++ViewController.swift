...
class C__ViewController: UIViewController ,UITableViewDelegate , UITableViewDataSource , UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        self.title = "Trending"
        Alamofire.request("https://github.com/trending/c++?since="+whatPeriod).responseString { response in
            ...
            let tap = UITapGestureRecognizer(target: self,action:#selector(C__ViewController.hideKeyboard(tapG:)))
